...
public class BibleService {
    ...
    public List<BibleDto> getVersesByBookname(String bookname) throws RecordNotFoundException {
        if (bibleRepository.existsByBooknameIgnoreCase(bookname)) {
            List<Bible> bibles = bibleRepository.getByBooknameIgnoreCase(bookname);
            ...
            throw new RecordNotFoundException("Bookname not found");
        }
    }
